...
class Parameters:
    def __init__(self):
        self.base_dir = '../data'
        self.dir_pos_examples = "../data/exemplePozitive"
        self.dir_neg_examples = "../data/exempleNegative"
        self.dir_test_examples = ""  # 'exempleTest/CursVA'   'exempleTest/CMU+MIT'
        ...
        self.overlap = 0.3
        self.number_positive_examples = 7236  # numarul exemplelor pozitive
